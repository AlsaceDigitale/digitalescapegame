...
{	
	...
	$wl_theme_options['btn_text']=__("Read More",'guardian');	
	$wl_theme_options['home_blog_description']=__("Latest Blog",'guardian');
...
{	
	...
	$wl_theme_options['contact_email']=__("guardian@mail.com",'guardian');
...
{	$wl_theme_options = get_option('guardian_options');
	$wl_theme_options['footer_customizations']=__("Copyright @ 2018 Guardian.",'guardian');
